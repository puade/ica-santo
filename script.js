...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbyK0D1bB4HwRvVqG9wq7_kwYGk4d9p8lHpQbCTCw2wKIH8LHDMrOww2H7ZHTawb3jiO/exec'; // Ganti dengan URL Web App Google Apps Script Anda
...
document.getElementById('formPernikahan').addEventListener('submit', function(event) {
  ...
  fetch('https://script.google.com/macros/s/AKfycbyK0D1bB4HwRvVqG9wq7_kwYGk4d9p8lHpQbCTCw2wKIH8LHDMrOww2H7ZHTawb3jiO/exec', {
    method: 'POST',
